...
$pageTitle = t('admin.messages.page_title') . ' - ' . APP_NAME;
require_once __DIR__ . '/../includes/header.php';
?>

<div class="container" style="max-width:820px">
    <h1 class="page-title mt-4 mb-3"><?= e(t('admin.messages.heading')) ?></h1>

    <?php if ($success): ?>
        <div class="alert alert-success"><i class="bi bi-check-circle me-2"></i><?= e(t('admin.messages.sent')) ?></div>
    <?php endif; ?>

    <div class="card section-card p-4 mb-4">
        <h5 class="fw-bold mb-3"><?= e(t('admin.messages.compose')) ?></h5>
        <form method="post" novalidate>
            ...
            <div class="row g-3">
                <div class="col-md-5">
                    ...
                    <select name="receiver_id" class="form-select" required>
                        <option value=""><?= e(t('admin.messages.select_client')) ?></option>
            ...
            <button class="btn btn-primary mt-3 rounded-pill"><i class="bi bi-send me-2"></i><?= e(t('common.send')) ?></button>
        </form>
    </div>

    <h5 class="fw-bold mb-3"><?= e(t('admin.messages.all_messages')) ?></h5>
    <?php foreach ($messages as $msg): ?>
        <div class="card section-card p-3 mb-2">
            <small class="text-muted">
                <strong><?= e($msg['sender_name'] ?? t('common.unknown')) ?></strong> → <strong><?= e($msg['receiver_name'] ?? t('common.unknown')) ?></strong>
                &middot; <?= e(format_datetime($msg['created_at'])) ?>
                <?php if (!$msg['is_read']): ?><span class="badge bg-danger ms-1"><?= e(t('admin.messages.unread')) ?></span><?php endif; ?>
            </small>
